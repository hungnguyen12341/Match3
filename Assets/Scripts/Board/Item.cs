...
public class Item
{
    ...
    public virtual void SetView()
    {
        ...
        if (!string.IsNullOrEmpty(prefabname))
        {
            ...
            if (prefab)
            {
                ...
                m_CellList = Resources.Load<CellListSO>("CellList");
                View.GetComponent<SpriteRenderer>().sprite = m_CellList.cellList[GetItemTypeAsInt()].sprite;
    ...
    protected virtual int GetItemTypeAsInt() { return 0; }
